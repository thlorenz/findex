...
test('\nfork - when indexing esprima', function (t) {
  t.plan(4)
...
test('\nfork - when indexing JSONSelect', function (t) {
  t.plan(7)
...
test('\nfork - when indexing ecstatic', function (t) {
  t.plan(3)
...
test('\nfork - when indexing everything, except some huge modules', function (t) {
  t.plan(10)
